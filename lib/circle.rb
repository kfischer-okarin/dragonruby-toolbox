...
module DRT
  ...
  module Circle
    ...
    # Builds a circle by rendering a quarter to a render target
    class CircleBuilder
    ...
    # Renders a pixel perfect quarter of a circle by first generating lines for 1/8th and duplicating them with
    # swapped x/y coordinates (i.e. mirroring them around a 45 degree axis)
    ...
    # Uses the border generated by BorderRenderer and fills it up with solids to create a filled circle
